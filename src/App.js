   ...
   return (
      <div className='w-full flex-col relative font-simpsons overflow-x-hidden'>
         <div className="flex flex-col bg text-simpsons w-full h-full relative">
            ...
            <div className="flex bg-header justify-between h-20 md:h-24 w-full p-4 items-center text-black-outline-thin absolute top-0 z-10">
               ...
               <div className="w-1/3 md:w-1/5 flex justify-end items-center">
                  <div className="flex flex-col items-center pt-2 cursor-pointer" href="">
                     <img className="w-16 h-auto" src={buynow} alt="buynow" />
                  </div>
               </div>
            </div>
            ...
            <div className='w-screen pb-20 md:pb-0 flex items-center lg:h-screen justify-center px-8 flex-col relative text-[rgb(253,203,0)]'>
               <div className='md:-mt-16 mt-20 w-full flex flex-col md:flex-row'>
                  ...
                  <div className='w-full md:w-2/3 flex flex-col h-full justify-center items-center lg:items-start mt-10 md:mt-0 lg:pl-12'>
                     <div className="text-5xl md:text-[90px] lg:mt-4 font-bold text-black-outline"> Corona Beerus </div>
                     ...
                     <div className="w-full flex flex-col items-center lg:items-start mt-4 text-black">
                        <div className="items-center justify-center w-full text-xl">
                           <div className="flex items-center justify-center lg:justify-start text-xs lg:text-2xl w-full">
                              <div ref={textRef} className="mr-2 text-white">{copied ? 'Copied!' : 'CA:' + CA}</div>
            ...
            <div 
               id='about-section' 
               className='w-screen bg-about min-h-screen py-16 md:py-32 h-auto flex flex-col md:flex-row px-8 md:px-32 border-y-4 border-black relative text-white'
            ...
            <div id='tokenomics-section' className='w-screen bg-tokenomics py-16 md:py-32 h-auto flex flex-col md:flex-row items-center justify-center px-8 md:px-32'>
               ...
               <div className="w-full md:w-1/2 flex flex-col mt-12 md:mt-0">
                  <div className="text-4xl md:text-6xl font-semibold text-white text-black-outline-thin"> Beer 'O' Nomics </div>
                  <div className="mt-4 md:mt-8 pl-1 only:pr-20 text-base text-white md:text-lg text-black"> 
            ...
            <div id="roadmap-section" className="w-screen py-16 md:pt-32 h-auto flex flex-col md:flex-row items-center justify-center px-8 md:px-32">
               <div className="w-full md:w-1/2 flex flex-col">
                  <div className="text-4xl md:text-6xl font-semibold text-white text-black-outline-thin"> Bar Crawl Route </div>
                  <div className="mt-4 md:mt-8 pl-1 md:pr-8 text-base text-white md:text-lg text-black"> 
            ...
            <div className="flex items-center justify-center flex-col mb-8">
               ...
               <a href="https://duff-coin.xyz" className="mt-4 font-sans text-3xl text-white font-bold text-black-outline-thin">&copy; Copyright 2024 all reserved - $CORONA</a>
            </div>
         </div>
      </div>
   );
